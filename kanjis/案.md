...
## Mnemonics
 * Trees are cheap, that is why my plan is to build a house out of trees.<br><br>A <span style="background-color:#ADD8E6"> cheap</span> <span style="background-color:#ADD8E6"> tree</span> has a <span style="background-color:#ffcccb"> plan</span>. A plan to stay cheap.
...
## Vocabulary
 * [案内](../vocabulary/案.md), (Guide, Information, Invitation)
